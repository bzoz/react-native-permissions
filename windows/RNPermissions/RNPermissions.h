...
namespace RNPermissions
{
  ...
  struct RNPermissions
  {
    ...
    void OpenSettings(bool error, React::ReactPromise<void>&& promise) noexcept;

    REACT_METHOD(CheckNotifications);
    void CheckNotifications(bool error, React::ReactPromise<std::string>&& promise) noexcept;
